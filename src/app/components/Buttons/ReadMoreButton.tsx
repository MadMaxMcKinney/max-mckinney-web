...
const ReadMoreButton = (props: ReadMoreButtonProps) => {
    return (
        <Link
            ...
            className={`flex w-fit gap-2 group bg-[#0C0C12] items-center justify-center rounded-md px-4 py-2 border border-solid border-white/20 transition transform shadow-white/5 shadow-xl hover:bg-[var(--accentColor)] hover:border-white active:scale-95 hover:text-black`}
        >
