...
function FolderBackdropCard(props: { children: React.ReactNode; index: number }) {
    const cardStyles: any = {
        1: "-z-10 scale-95 -translate-y-4 sm:-translate-y-6 group-hover:-translate-y-5 sm:group-hover:-translate-y-8 delay-75",
        2: "-z-20 scale-90 -translate-y-8 sm:-translate-y-12 group-hover:-translate-y-9 sm:group-hover:-translate-y-14 delay-100",
    };
