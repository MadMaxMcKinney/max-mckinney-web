...
const Footer = () => {
    return (
        <footer className="px-6">
            <FadeIn delay={0.3} duration={1.5} className="flex flex-col justify-between mt-20 mb-16 mx-auto w-full sm:mb-10 sm:mt-40 sm:flex-row md:mt-32 max-w-[var(--content-max-width)]">
                {/* Social */}
