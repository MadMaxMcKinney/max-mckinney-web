        ...
        <div>
            ...
            <div className="contained-content mt-12 flex flex-col gap-6 items-start">
                ...
                <div className="inline-grid grid-flow-col gap-3">
                    <Pill type="primary" text={frontmatter.projectRole} />
                </div>

                {/* Words */}
                <div className="flex flex-col gap-4">
                    <MHeading02>{frontmatter.title}</MHeading02>
                    <MBody className="text-zinc-400 flex-1">{frontmatter.projectShortBrief}</MBody>
                </div>

                <div id="ProjectActions">
                    <ReadMoreButton accent={frontmatter.accentColor} href={`/work/${slug}`}>
                        View case study
                    </ReadMoreButton>
                </div>
            </div>
