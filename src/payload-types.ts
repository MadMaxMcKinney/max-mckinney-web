...
export interface Config {
  ...
  collectionsJoins: {};
  collectionsSelect: {
    'work-projects': WorkProjectsSelect<false> | WorkProjectsSelect<true>;
...
/**
 * Professional / client case studies shown on the home page and /work.
 *
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "work-projects".
 */
export interface WorkProject {
  id: string;
  title: string;
  /**
   * One- or two-sentence summary (card + header).
   */
  projectShortBrief: string;
  /**
   * Longer brief used for SEO/description.
   */
  projectBrief: string;
  body?: {
    root: {
...
/**
 * Personal projects shown on /personal.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface PersonalProject {
  ...
  title: string;
  /**
   * Summary shown on the card and project header.
   */
  description: string;
  body?: {
    root: {
...
export interface PayloadLockedDocument {
  ...
  document?:
    | ({
        relationTo: 'work-projects';
        value: string | WorkProject;
      } | null)
    | ({
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "work-projects_select".
 */
export interface WorkProjectsSelect<T extends boolean = true> {
  title?: T;
  projectShortBrief?: T;
  projectBrief?: T;
  body?: T;
...
export interface GalleryBlock {
  images?:
    ...
    | null;
  /**
   * Optional caption shown beneath the row.
   */
  subtitle?: string | null;
  id?: string | null;
  blockName?: string | null;
