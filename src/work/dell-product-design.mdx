...
themeColor: "#6923e0"
accentColor: "#0095ff"
image: "/work/dell-product/dell-welcome-header.jpg"
thumb: "/work/dell-product/dell-welcome-thumb.jpg"
sortDate: "2015-12-01"
postType: "professional-project"
---

I worked with the R&D design and development team within Dell to create and explore the future of Dell's products. I refer to this work as 'Conceptual UI/UX Design' as the work can vary quite a bit in the medium in which the 'interface' exists. Traditional UI design refers explicitly to the screens we are used to today, like our phones and monitors. The R&D team dealt with future looking concepts, like having a projected 'interface' displayed on your desk, or an 'interface' with no visuals only haptic feedback. This experience allowed for deep creativity and an abundance of problem solving.

<ImageContainer
    srcs={["/work/dell-product/dell-rd-3.png", "/work/dell-product/dell-rd-4.png"]}
    alts={["Shown is a tablet performance checkup app", "Shown is a git-style branching application"]}
    subtitle="Prototype Android applications"
/>

<ImageContainer
    srcs={["/work/dell-product/dell-rd-6.png", "/work/dell-product/dell-rd-7.png"]}
    alts={["Shown is performance analysis desktop application", "Shown is a chart highlighting internet speeds"]}
    subtitle="Enterprise applications integrated with Deep Data"
/>
...
<ImageContainer src="/work/dell-product/dell-rd-10.png" alt="Shown is a prototype projector interface application" subtitle="Prototype projector interface application" />

<ImageContainer
    srcs={["/work/dell-product/dell-rd-9.png", "/work/dell-product/dell-rd-8.png"]}
    alts={["Shown is performance analysis desktop application", "Shown is a chart highlighting internet speeds"]}
    subtitle="Prototype projector interface application pages"
/>
...
<ImageContainer
    srcs={["/work/dell-product/dell-welcome-screenshot-3.png", "/work/dell-product/dell-welcome-screenshot-4.png"]}
    alts={["Shown is Dell's 'Welcome to Windows 10' app", "Shown is Dell's 'Welcome to Windows 10' app"]}
    subtitle="Dell 'Welcome to Windows 10'"
/>
...
<ImageContainer srcs={["/work/dell-product/dell-rd-1.png", "/work/dell-product/dell-rd-2.png"]} alts={["Shown is Dell's hub app ", "Shown is Dell's hub app"]} subtitle="Dell Hub" />
