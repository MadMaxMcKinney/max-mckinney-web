...
<ImageContainer
    ...
    subtitle="Cover art for the Figma Voice Memo widget"
/>
...
Education design provided a unique opportunity to work across multiple teams and departments at Figma, learn and educate on design concepts, and build unique educational experiences that directly impacted Figma's users. The result of this work is felt across the company and has assisted in the approachability of Figma's product experiences, drove positive revenue through improved user retention, all while providing free and valuable learning resources to the community.
