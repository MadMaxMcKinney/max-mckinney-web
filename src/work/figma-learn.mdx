...
Redesigning and rebuilding Figma’s Help Center was an effort that blended frontend engineering, design systems thinking, and author tooling into a single (limited) platform. The work required pushing Zendesk far beyond its intended use case, while maintaining reliability and ease-of-use for both authors and end users.
