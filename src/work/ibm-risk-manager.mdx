...
themeColor: "#191028"
accentColor: "#883EF8"
image: "/work/ibm/IBM_Risk_Manager_Background.png"
thumb: "/work/ibm/IBM_Risk_Manager_Preview.png"
sortDate: "2021-12-01"
---
...
<ImageContainer src="/work/ibm/ibm_asset_2.png" alt="Shown is a picture of myself, Max McKinney, presenting virtually for a conference talk" subtitle="Spark Festival Design Presentation" />
...
<ImageContainer
    srcs={["/work/ibm/ibm_asset_14.png", "/work/ibm/ibm_asset_15.png"]}
    alts={["Shown is a Figma plugin and red lines from Risk Manager", "Shown is the Carbon Design System landing page"]}
    subtitle="Figma tokens, Carbon Design, Tools for alignment"
/>
...
<ImageContainer
    srcs={["/work/ibm/ibm_asset_4.png", "/work/ibm/ibm_asset_6.png"]}
    alts={["Shown is explorative work on a whiteboard and sticky notes", "Shown is explorative work on a whiteboard and sticky notes continued"]}
    subtitle="Rethinking page flows and risk models (some data blurred)"
/>
...
<ImageContainer
    srcs={["/work/ibm/ibm_asset_11.png", "/work/ibm/ibm_asset_12.png"]}
    alts={["Shown is a list of user results in a power point", "Shown is problem statement and wireframe example"]}
    subtitle="User testing results"
/>
...
<ImageContainer
    srcs={["/work/ibm/ibm_asset_9.png", "/work/ibm/ibm_asset_10.png"]}
    alts={["Shown is a list of user results in a power point from a user test", "Shown is current experience outline and a new proposed experience outline"]}
    subtitle="D&UX testing results"
/>
...
<ImageContainer
    srcs={["/work/ibm/ibm_asset_8.png", "/work/ibm/ibm_asset_5.png"]}
    alts={["Shown is a snippet of the Risk Manager UI with redlines and outlines of components", "Shown is more snippets of the Risk Manager UI with redlines and outlines of components"]}
    subtitle="Tokens, symbols, redlines, and new 'module' components"
/>
...
<ImageContainer src="/work/ibm/IBM_Risk_Manager_Preview.png" alt="Shown is the Risk Manager UI, with a dashboard showing security issue" subtitle="Risk Manager UI" />
